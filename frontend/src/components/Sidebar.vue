  ...
  <aside class="sidebar" :class="{ collapsed: isCollapsed, open: isOpen, hidden: !isOpen }">
    ...
    <nav class="sidebar-nav">
      <div class="nav-section">
        <router-link to="/back_office/dashboard" class="nav-item" active-class="active">
          <span class="nav-icon">
        ...
        <router-link to="/back_office/appels" class="nav-item" active-class="active" v-if="userRole !='inspecteur'">
          <span class="nav-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
        ...
        <router-link to="/back_office/tickets" class="nav-item" active-class="active">
          <span class="nav-icon">
      ...
      <div class="nav-section" v-if="['admin', 'manager', 'superviseur'].includes(userRole)">
        ...
        <router-link to="/back_office/typerequetes" class="nav-item" active-class="active">
          <span class="nav-icon">
           <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <router-link to="/back_office/typeappels" class="nav-item" active-class="active">
          <span class="nav-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <router-link to="/back_office/localites" class="nav-item" active-class="active">
          <span class="nav-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <router-link to="/back_office/utilisateurs" class="nav-item" active-class="active" v-if="['admin'].includes(userRole)">
          <span class="nav-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <router-link to="/back_office/equipes" class="nav-item" active-class="active" v-if="['admin'].includes(userRole)">
          <span class="nav-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <router-link to="/back_office/rapports" class="nav-item" active-class="active">
          <span class="nav-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
